...
//    // 3. 내 구매내역
//    @GetMapping("/orders")
//    public List<Order> getMyOrders(@AuthenticationPrincipal Member member) {
//        return memberService.findMyOrders(member.getUsername());
//    }
//
//    // 4. 내가 쓴 리뷰
//    @GetMapping("/reviews")
//    public List<Review> getMyReviews(@AuthenticationPrincipal Member member) {
//        return memberService.findMyReviews(member.getUsername());
//    }
//
//    // 5. 내 문의글
//    @GetMapping("/inquiries")
//    public List<Inquiry> getMyInquiries(@AuthenticationPrincipal Member member) {
//        return memberService.findMyInquiries(member.getUsername());
//    }
}
